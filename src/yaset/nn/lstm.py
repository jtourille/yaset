...
class LSTMAugmented(nn.Module):
    ...
    def forward(self, batch_packed):
        ...
        forward_unpacked, forward_len = pad_packed_sequence(
            out_forward, batch_first=True
        )
        backward_unpacked, backward_len = pad_packed_sequence(
            out_backward, batch_first=True
        )
